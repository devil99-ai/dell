...
def change_working_directory_sonicos4():
    os.chdir(r"C:\Users\svksh\OneDrive\Desktop\python_mysql\sonicos4")
...
def device_safe_commands(
    ...
    if action == "get_device_information":
        ...
        file_input_path = os.path.join(r'C:\Users\svksh\OneDrive\Desktop\python_mysql', file_input)
        file_ouput_name = f"{hostname}.yml"
        file_ouput_path = os.path.join(r'C:\Users\svksh\OneDrive\Desktop\python_mysql', file_ouput_name)
        if os.path.exists(file_ouput_path):
            new_file_name = f"{hostname}.{int(time.time())}.yml"
            new_file_path = os.path.join(r'C:\Users\svksh\OneDrive\Desktop\python_mysql', new_file_name)
    ...
    playbook_path = r'C:\Users\svksh\OneDrive\Desktop\python_mysql\setup_config.yml'
    ...
    ansible_command = [
        ...
        extra_vars,
        ansible_file,
        license_key_command,playbook_path,
        verbose,
    ]
